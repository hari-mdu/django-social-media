...
class Users(models.Model):
    ...
    user_name = models.CharField(db_column='User_Name', unique=True, max_length=50)  # Field name made lowercase.
    ...
    profile_image = models.CharField(db_column='Profile_Image', max_length=255, blank=True, null=True)  # Field name made lowercase.
    deleted_on = models.DateTimeField(db_column='Deleted_On', blank=True, null=True)  # Field name made lowercase.
